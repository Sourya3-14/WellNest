...
import PendingAppointmentsPage from "./pages/doctors/PendingAppointmentsPage";
import ScheduledAppointmentsPage from "./pages/doctors/ScheduledAppointmentsPage";
        ...
        <ConnectKitProvider>
          <Router>
            <Routes>
              ...
              <Route path="/pending-appointments" element={<PendingAppointmentsPage />} />
              ...
              <Route path="/events/organize/:eventType" element={<OrganizeEventForm />} />
              <Route path="/events/participants/:eventId" element={<EventParticipantsPage />} />
              <Route path="/events/register/:eventId" element={<ParticipantRegistration />} />
